...
const EditProfile = () => {
  ...
  useEffect(() => {
    axios
      .post(`http://localhost:3000/api/users/hasdj`, {
  ...
  return (
    <div className="mt-[12vh] w-full ml-[25vw] mr-[5vw]">
      <div className="flex items-center justify-between gap-10">
        ...
        <Dialog>
          <DialogTrigger className="w-[130px] h-[100px] ">
          <Image
          className="p-[1.5px] w-[100px] h-[100px] rounded-full hover:cursor-pointer bg-white "
